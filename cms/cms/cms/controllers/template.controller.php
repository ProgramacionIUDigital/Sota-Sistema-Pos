	...
	static public function sendEmail($subject, $email, $title, $message, $link){
		...
		$mail->msgHTML('
			...
			<div style="width:100%; background:#eee; position:relative; font-family:sans-serif; padding-top:40px; padding-bottom: 40px;">
				...
				<div style="position:relative; margin:auto; width:600px; background:white; padding:20px"><div style="position:relative; margin:auto; width:600px; min-height:500px; background:white; padding:20px">
